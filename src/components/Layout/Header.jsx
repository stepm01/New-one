  ...
  useEffect(() => {
    ...
    window.addEventListener("scroll", () => {
      ...
      if (scrollDirection > lastScrollTop) {
        ...
        currentScroll.current.classList =
          "opacity-1 transition ease-in-out duration-500";
        setNav(false);
      }
    ...
    <>
      <header ref={currentScroll}>
        ...
        >
          ...
          <ul className="hidden md:col-start-6 md:flex  md:col-span-3 md:justify-self-end md:items-center lg:col-start-10 z-10">
            <li
              className={`${
          ...
          <div
            className="col-start-4 self-center md:hidden"
            onClick={handleNav}
          >
            <div
              className={`${
      ...
      <div>
        <div
          className={`${
            !nav ? "top-[-30%]" : "top-18"
          } text-center ease-in-out duration-700 fixed w-[100%] z-0 flex flex-col justify-center bg-gray-200 md:hidden`}
        >
          <div
            className={`${
